...
define('UNIONPAY_ROOT', dirname(dirname(__FILE__)));
// ######(以下配置为PM环境：入网测试环境用，生产环境配置见文档说明)#######
// 签名证书路径
const SDK_SIGN_CERT_PATH = UNIONPAY_ROOT.'/cert/310420152110006.pfx';

// 签名证书密码
const SDK_SIGN_CERT_PWD = '111111';

// 密码加密证书（这条一般用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = UNIONPAY_ROOT.'/cert/acp_prod_enc.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = UNIONPAY_ROOT.'/cert/';
