...
class Favorites extends Model{
     ...
     */
    public function getFavoriteGoodsList( $where, $whereOr, $field ) {
        $join = [['mgt_goods g','g.goods_id=f.goods_id']];
        $list = $this->field($field)->alias('f')->join($join)->where($where)->where($whereOr)->paginate(10);
        return $list;
    }
     ...
     * @return false|\PDOStatement|string|\think\Collection
     */
    public function getFavoriteLogsGoodsList( $where, $whereOr, $field ) {
     ...
     * @return false|\PDOStatement|string|\think\Collection
     */
    public function getFavoriteProductionList( $where, $whereOr, $field ) {
